...
Please make sure that these packages are installed, ad well as 'ini', 'hash', and OpenCyto (if you are planning to do automatic gating). Cytofpipe_v1.2 has been tested in R.3.4.2 with cytofkit 1.10.0 (available from bioconductor 3.5), scaffold 1.0, and citrus 0.08, and therefore we recommend that you install these specific versions to avoid potential clashes with older/newer versions. 
